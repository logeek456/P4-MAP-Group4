...
randomx0same = np.tile([np.random.uniform(-15.0, 15.0) for _ in range(len(centers))], int(N/n_clusters))
print("emplacements initiaux (meme endroit) : ", randomx0same)
print("emplacements initiaux (aleatoires) : ", randomx0)
print("avec kmeans : ", x0)
